...
<title>Foody</title>
 ...
 <meta name="google-signin-scope" content="profile email">
    <meta name="google-signin-client_id" content="921778666331-272ss10n7r6au5fitcb3ugfkkcm1o2e9.apps.googleusercontent.com">
...
%>
	...
	<i style="font-size: 20px;" class="fa fa-<%=msg.getIcon()%>"></i> <%= msg.getType() %>
